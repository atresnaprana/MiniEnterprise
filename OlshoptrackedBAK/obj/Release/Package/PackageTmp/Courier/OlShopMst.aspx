<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OlShopMst.aspx.cs" Inherits="OlshoptrackedBAK.Courier.OlShopMst" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <telerik:RadAjaxPanel ID="ajaxpanel" runat="server">
        ...
        <telerik:RadGrid ID="rgOlShop" ExportSettings-Pdf-AllowPrinting="true" runat="server" Height="750px"
            ...
            OnItemCommand="rgOlShop_ItemCommand" OnItemDataBound="rgOlShop_ItemDataBound" OnNeedDataSource="rgOlShop_NeedDataSource"
            OnEditCommand="rgOlShop_EditCommand" OnUpdateCommand="rgOlShop_UpdateCommand" OnPreRender="rgOlShop_PreRender" OnDeleteCommand="rgOlShop_DeleteCommand" OnInsertCommand="rgOlShop_InsertCommand" OnPageIndexChanged="rgOlShop_PageIndexChanged" OnPageSizeChanged="rgOlShop_PageSizeChanged"
            ...
            <MasterTableView AllowFilteringByColumn="false" CommandItemDisplay="Top" DataKeyNames="OLSHOP_CODE"
                EditMode="InPlace" PagerStyle-Mode="NextPrevAndNumeric" ClientDataKeyNames="OLSHOP_CODE" Width="150%">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn AllowFiltering="false" FilterControlAltText="Filter TemplateColumn column"
                        HeaderText="Code" UniqueName="OLSHOP_CODE" HeaderStyle-Font-Size="13px" HeaderStyle-Font-Names="Verdana" SortExpression="OLSHOP_CODE">
                        <ItemTemplate>
                            <asp:Label ID="hdrcodetxt" Width="90%" runat="server" Text='<%# Eval("OLSHOP_CODE") %>'></asp:Label>
                            <asp:HiddenField ID="hiddencode" Value='<%# Eval("OLSHOP_CODE") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <telerik:RadTextBox ID="hdrcodetxt" Text='<%# Eval("OLSHOP_CODE") %>' ReadOnly="true" runat="server"></telerik:RadTextBox>
                        </EditItemTemplate>
                        <InsertItemTemplate>
                    ...
                    <telerik:GridTemplateColumn AllowFiltering="false" FilterControlAltText="Filter TemplateColumn column"
                        HeaderText="Name" UniqueName="OLSHOP_NAME" HeaderStyle-Font-Size="13px" HeaderStyle-Font-Names="Verdana" SortExpression="OLSHOP_NAME">
                        <ItemTemplate>
                            <asp:Label ID="olshopname" Width="90%" runat="server" Text='<%# Eval("OLSHOP_NAME") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <telerik:RadTextBox ID="olshopname" Text='<%# Eval("OLSHOP_NAME") %>' runat="server"></telerik:RadTextBox>
                        </EditItemTemplate>
                        <InsertItemTemplate>
                            <telerik:RadTextBox ID="olshopname" runat="server"></telerik:RadTextBox>
                        </InsertItemTemplate>
                        <HeaderStyle Wrap="false" HorizontalAlign="Left" Width="100px" />
                        <ItemStyle HorizontalAlign="Left" Width="100px" />
                    </telerik:GridTemplateColumn>
